...
<!--							<xsl:choose>-->
<!--							<xsl:when test="not(//UserComment) or //UserComment = ''"></xsl:when>-->
<!--							<xsl:otherwise>-->
<!--							<ContractValueCompositeBObj>				-->
<!--						<TCRMContractValueBObj>             			-->
<!--							<ContractValueType>29</ContractValueType>-->
<!--							<ValueString/>		-->
<!--							<StartDate>-->
<!--							<xsl:call-template name="formatDate">-->
<!--									<xsl:with-param name="str" select="//SR_HEADER/SrDate" />-->
...
<!--							</StartDate>-->
<!--							<EndDate/>		-->
<!--							<Attribute0Type>59</Attribute0Type>-->
<!--							<Attribute0String>-->
<!--							<xsl:value-of select="//UserComment"/>-->
<!--							</Attribute0String>-->
<!--						</TCRMContractValueBObj>											-->
<!--					</ContractValueCompositeBObj>-->
<!--							</xsl:otherwise>-->
