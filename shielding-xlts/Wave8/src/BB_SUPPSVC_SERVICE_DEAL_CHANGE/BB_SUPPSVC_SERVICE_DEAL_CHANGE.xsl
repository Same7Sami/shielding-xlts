	...
	<xsl:template match="/">
		<TCRMService xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
			...
			<RequestControl>
				...
				<DWLControl>
					<requesterName>BBServiceDealChange</requesterName>
				...
				<TCRMObject>
					<ContractCompositeBObj>
						<ContractCompositeMBObj>
							...
							<xsl:choose>
								<xsl:when test="//OldServiceType != //ServiceType">
								...
								<ProductAdminSysKeyBObj>
									...
									<ProductAdminSysKeyPartOne>
										<xsl:value-of select="//OldServiceType"/>
									</ProductAdminSysKeyPartOne>
								</ProductAdminSysKeyBObj>
							</ProductContractRelationshipCompositeBObj>
							<ProductContractRelationshipCompositeBObj>
							...
							<TCRMContractValueBObj>             			
								<ContractValueType>37</ContractValueType>
								<xsl:if test="//PlanType and //PlanType!=''">
								<Attribute0Type>61</Attribute0Type>
								<Attribute0String>
