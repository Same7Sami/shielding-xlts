					...
					<ContractCompositeBObj>
						<ContractCompositeMBObj>
							...
							<xsl:choose>
								...
								<xsl:when test="//Operation ='TWININGS_REPLACE' or //Operation ='TWININGS_NATIONAL_REPLACE' or //Operation ='RBT_REPLACE' or //Operation ='IDD_REPLACE' or //Operation ='SAFE_ARRIVAL Repalce' or //Operation ='WHATSAPP_MONTHLY_REPLACE'">
								<ProductContractRelationshipCompositeBObj>
										<TCRMProductContractRelationshipBObj>
											<ProductContractRelationshipType>2</ProductContractRelationshipType>
											<TCRMExtension>
