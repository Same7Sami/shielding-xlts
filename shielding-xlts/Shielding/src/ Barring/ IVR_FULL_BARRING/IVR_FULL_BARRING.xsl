		...
		<TCRMService xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
			...
			<RequestControl>
				...
				<DWLControl>
					...
					<xsl:choose>
						<xsl:when test="//SR_HEADER/RequestorLanguage = 'E' or //SR_HEADER/RequestorLanguage = '1' or not(//SR_HEADER/RequestorLanguage) or //SR_HEADER/RequestorLanguage = ''">
						...
						<ContractCompositeMBObj>
							<TCRMContractBObj>
								...
								<TCRMExtension>
									...
									<XContractBObjExt>
									<BarringStatusType>4</BarringStatusType>
									<BarringReasonType>Reason will be here</BarringReasonType>
