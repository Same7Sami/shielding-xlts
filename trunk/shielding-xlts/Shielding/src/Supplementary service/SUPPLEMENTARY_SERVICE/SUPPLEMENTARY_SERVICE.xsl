		...
		<TCRMService xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
			...
			<TCRMTx>
				...
				<TCRMObject>
					...
					<xsl:choose>
						<xsl:when test="//Operation = 'EVMS_SUBSCRIBE'">
						...
						<xsl:when test="//Operation = 'LBS_SUB'">
							<ProductContractRelationshipCompositeBObj>
								<TCRMProductContractRelationshipBObj>
									<StartDate>
									<xsl:call-template name="formatDate">
						...
						<xsl:when test="//Operation = 'LBS_UNSUB'">
							<ProductContractRelationshipCompositeBObj>
								<TCRMProductContractRelationshipBObj>
									<EndDate>
									<xsl:call-template name="formatDate">
						...
						<xsl:when test="//Operation = 'MOBILY_TV_SUB'">
							<ProductContractRelationshipCompositeBObj>
								<TCRMProductContractRelationshipBObj>
									<StartDate>
									<xsl:call-template name="formatDate">
						...
						<xsl:when test="//Operation = 'MOBILY_TV_UNSUB'">
							<ProductContractRelationshipCompositeBObj>
								<TCRMProductContractRelationshipBObj>
									<EndDate>
									<xsl:call-template name="formatDate">
